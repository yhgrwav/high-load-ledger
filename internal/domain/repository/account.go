...
type AccountRepository interface {
	...
	DebitBalance(ctx context.Context, tx entity.CustomTx, id uuid.UUID, amount, postingID int64) error
	CreditBalance(ctx context.Context, tx entity.CustomTx, id uuid.UUID, amount, postingID int64) error
}
